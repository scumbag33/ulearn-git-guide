...
- `git branch -f <branchname>` — переместить ветку
- `git branch -M <newbranch>` — переместить ветку, даже если новое имя уже занят
